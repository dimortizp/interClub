...
Yii::app()->clientScript->registerScriptFile(
        Yii::app()->baseUrl . '/js/organictabs.jquery.js', CClientScript::POS_END
);

Yii::app()->clientScript->registerScriptFile(
        Yii::app()->baseUrl . '/js/galleria/galleria-1.2.8.min.js', CClientScript::POS_END
);

Yii::app()->clientScript->registerScriptFile(
        Yii::app()->baseUrl . '/js/galleria/themes/classic/galleria.classic.min.js', CClientScript::POS_END
);
...
$this->breadcrumbs = array(
    $model->destinosIdDestino->nombre, Yii::t('ui',$model->nombre) => array('site/plan', 'id'=>$model->idPaquete)
);
...
verConoceMas=function(){
    $('#formPlan').hide('slow', function() {
        $('.mail_confirmation').hide('slow', function() {
            // Animation complete
        });

        $('#conMas').show('slow', function() {
        $('.galleria-info-text').css('display','block');
        $('.galleria-info-link').css('display','none');
        $('.galleria-info-close').css('display','block');
...
loadConfirmation=function(){
    ...
    $('.mail_confirmation').show('slow', function() {
        // Animation complete
    });

    $('.mail_confirmation').animate({opacity: 1.0}, 9000).fadeOut('slow');

}

mostrarTienda=function(value){

    if(value=='Tienda'){
         $('.dropdown_tiendas').show('slow', function() {
    });
...
<!-- FORMULARIO NO VERIFICADO-->
<?php if ($reservo == 2) echo'<script> setTimeout( function() {reloadFormulario();}  , 1000 ); </script>'; ?>
<!--FORMULARIO ENVIADO-->
<?php
if ($reservo == 3) {

    echo'<script> setTimeout( function() {loadConfirmation();}  , 1000 ); </script>';

//    Yii::app()->clientScript->registerScript(
//        'myHideEffect',
//        '$(".mail_confirmation").animate({opacity: 1.0}, 3000).fadeOut("slow");',
...
<div class="content">
    <div class="content1">
        ...
        <div class="social">
            <?php
//create a link
            echo CHtml::link('', Yii::app()->createUrl('site/recomendar',array('id'=>$idPlan)), array("id" => "fancy-link", "class" => "bot_recomendar fancybox"));
...
//put fancybox on page
            ...
            ?>
            <div style="width:100px;float:left"><fb:like href="<?php echo Yii::app()->createAbsoluteUrl('site/plan',array('id'=>$idPlan,'rnd'=>1)); ?>" send="false" layout="button_count" width="100" show_faces="true"></fb:like></div>
            <a href="https://twitter.com/share"  class="twitter-share-button" data-url="<?php echo Yii::app()->createAbsoluteUrl('site/plan',array('id'=>$idPlan)); ?>" data-lang="en" data-via="ViajarFalabella">Tweet</a>
            ...
            <div class="list-wrap">
                ...
                <div id="featured2">
                    ...
                    <div class="content_conocemas">
                        <div class="conocemas_texto">
                            <p><?php echo $model->info_general; ?></p>
                        </div>
                ...
                <div id="core2" class="hide">
                    ...
                    if ($model->latitud != 0 && $model->longitud != 0) {
                        ...
                        echo'<img class="mapa" src="img/mapa.jpg" width="491" height="248" />';
                    ?>

                    <div class="content_conocemas">
                        <?php
                        if ($model->que_hacer){
                            echo'<div><h4 class="quehacer">¿quÉ hacer?</h4>';
                            echo $model->que_hacer . '</div>';
                        }
                        if ($model->tips_viajero){
                            echo'<div><h4 class="tips">Tips para viajeros</h4>';
                            echo'<ul class="no-margin">' . str_replace(array("<ul>","</ul>"),"", $model->tips_viajero) . '</ul></div>';
                        }
                        ?>
                ...
                <div id="jquerytuts2" class="hide">  
                    ...
                    <?php foreach ($instag as $key => $photo) { ?>
                        <div class="img_sombra" style="<?php echo($key == 0) ? 'display:block' : 'display:none'; ?>;width: 372px;" id="principal<?php echo $key; ?>"><img src="<?php echo $photo->images->standard_resolution->url; ?>" width="372" height="356" /></div>
...
//                echo CActiveForm::validate($reserva);
                ...
                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-top: 2px; margin-bottom: 1px;">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->textField($reserva, 'nombre', array('size' => 60, 'maxlength' => 100, 'class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->textField($reserva, 'apellidos', array('size' => 60, 'maxlength' => 100, 'class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->textField($reserva, 'documento', array('size' => 20, 'maxlength' => 20, 'class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>

                </div>

                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-top: 2px; margin-bottom: 0px;">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->textField($reserva, 'email', array('size' => 60, 'maxlength' => 100, 'class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->textField($reserva, 'direccion', array('size' => 60, 'maxlength' => 200, 'class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>

                </div>

                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-top: 4px; margin-bottom: 1px;">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->textField($reserva, 'telefono', array('size' => 20, 'maxlength' => 20, 'class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->dropDownList($reserva, 'ciudad', $ciudades, array('prompt'=>'Seleccione ciudad',
                                                                                            'ajax' => array(
                                                                                                           'type'=>'POST',
                                                                                                            'url'=>CController::createUrl('site/itemsTienda'), 
                                                                                                            'dataType'=>'json',
                                                                                                            'data'=>array('ciudad'=>'js:this.value'),  
                                                                                                            'success'=>'function(data) {
                                                                                                                $("#dropdown_tienda").html(data.dropDownTiendas);
                                                                                                               
                                                                                                            }',
                                                                                                           
                                                                                                           ), 
                                                                                            'class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-bottom: 0px; margin-top: 0px;">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo CHtml::label($model->nombre, '', array('class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; margin-right:10px;width:95%; margin-bottom:1px;')); ?>


                        <?php
//                        echo $form->textField($reserva,'paquetes_idPaquete',array('readonly'=>true, 'class'=>'text_incluye style1', 'align'=>'right', 'style'=>'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;'));
                        ?>
                    </div>
                ...
                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-bottom: 2px; margin-top: 4px;">
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:52%; float:right;">
                        <label class="text_incluye style1" align="right" style="line-height:30px; margin-right:10px;width:95%; margin-bottom:1px; padding: 0px;"> &nbsp; </label>
                    </div>

                </div>

                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-bottom: 0px; margin-top: 4px;">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->dropDownList($reserva, 'num_adultos', $numeros_adultos, array('class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->dropDownList($reserva, 'num_ninos', $numeros, array('class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:50%; float:right;">
                        <?php echo $form->dropDownList($reserva, 'num_infantes', $numeros, array('class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row" >
                    <div height="30" align="left" class="text_incluye style1" style="width:58%; float:left;">
                        <?php echo $form->label($reserva, 'forma_pago', array('class' => 'text_incluye style1', 'align' => 'left', 'style' => 'line-height:30px; margin-right:10px;')); ?>
                    </div>
                    <div height="30" align="left" class="text_incluye style1" style="width:2%; float:right; display:inline-block;">
                        <span class="asterisco">*</span>
                    </div>
                     <div height="30" align="left" class="text_incluye style1" style="width:40%; float:right;">
                        <?php echo $form->dropDownList($reserva, 'forma_pago', $array_forma_pago, array( 'prompt'=>'Seleccione forma de pago', 'class' => 'text_incluye style1', 'align' => 'right', 'onchange'=>'mostrarTienda(value);', 'style' => 'line-height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row" class="dropdown_tiendas" style="height:30px; display:none;">
                    <div height="30" align="left" class="text_incluye style1" style="width:58%; float:left;">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:40%; float:right;">
                        <?php echo $form->dropDownList($reserva, 'donde_pago_idDondePago', $array_tienda, array('id'=>'dropdown_tienda','class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; width:95%; margin-bottom:1px; padding: 0px;')); ?>
                    </div>
                ...
                <div id="row">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:94%; float:right;">
                        <a id="terminos-fancybox" href="<? echo Yii::app()->createUrl('site/terminos'); ?>" style="line-height:20px; margin-left:10px;" align="right" class="text_incluye style1">Acepto  t&#233;rminos y condiciones de Ofertas L&#237;mite Viajes Falabella</a>
                    </div>
                    

                    <?php $this->widget('application.extensions.fancybox.EFancyBox', array(
                        'target' => 'a#terminos-fancybox',
                        'config' => array(
...
<!--        <td><input style="width:98px;" class="bot_cancelar" type="submit" name="button2" id="button" value="&nbsp;" />
            ...
            <div class="telefonos">
                ...
                <p>Comunicate con un asesor virtual y solicita este paquete</p><a id="chat" href="http://messenger.providesupport.com/messenger/viajesfalabellaco.html"></a>
            </div>
            <noscript>
    ...
    <div class="mail_confirmation" id="mail_con" style="display:none; width:300px; padding-bottom:10px;">

        <div class="alert alert-block alert-success style2">
