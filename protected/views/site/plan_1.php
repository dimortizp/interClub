...
$this->breadcrumbs = array(
    $model->destinosIdDestino->nombre, $model->nombre
);
...
loadConfirmation=function(){
    ...
    $('.mail_confirmation').animate({opacity: 1.0}, 6000).fadeOut('slow');
...
//put fancybox on page
            ...
            ?>
            <fb:like href="<?php echo Yii::app()->createAbsoluteUrl('site/plan',array('id'=>$idPlan,'rnd'=>1)); ?>" send="false" layout="button_count" width="100" show_faces="true"></fb:like>
...
//                echo CActiveForm::validate($reserva);
                ...
                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-top: 2px; " >
                ...
                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-top: 2px; margin-bottom: 2px;">
                ...
                <div id="row">
                    <div height="30" align="right" class="text_incluye style1" style="width:48%; float:left; margin-bottom: 1px; margin-top: 6px;">
