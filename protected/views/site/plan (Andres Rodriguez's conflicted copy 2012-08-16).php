...
//put fancybox on page
            ...
            <a href="https://twitter.com/share"  class="twitter-share-button" data-url="<?php echo Yii::app()->createAbsoluteUrl('site/plan',array('id'=>$idPlan)); ?>" data-lang="en">Tweet</a>
...
//                        echo $form->textField($reserva,'paquetes_idPaquete',array('readonly'=>true, 'class'=>'text_incluye style1', 'align'=>'right', 'style'=>'line-height:30px; height:30px; width:95%; margin-bottom:1px; padding: 0px;'));
                ...
                <div id="row" class="dropdown_tiendas" style="display:none;">
                    <div height="30" align="left" class="text_incluye style1" style="width:58%; float:left;">
                    ...
                    <div height="30" align="left" class="text_incluye style1" style="width:40%; float:right;">
                        <?php echo $form->dropDownList($reserva, 'donde_pago_idDondePago', $array_tienda, array('id'=>'dropdown_tienda','class' => 'text_incluye style1', 'align' => 'right', 'style' => 'line-height:30px; width:95%; margin-bottom:0px; padding: 0px;')); ?>
                    </div>
...
<!--        <td><input style="width:98px;" class="bot_cancelar" type="submit" name="button2" id="button" value="&nbsp;" />
            ...
            <div class="telefonos">
                ...
                <p>Comunicate con un asesor virtual y solicita este paquete</p><a href="http://messenger.providesupport.com/messenger/viajesfalabellaco.html"></a>
            </div>
            <noscript>
